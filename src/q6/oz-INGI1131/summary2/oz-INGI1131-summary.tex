...
\begin{figure}[H]
	...
	%\includegraphics[width=0.83\textwidth]{img/ParadigmsOverview.eps}
...
%\includegraphics[scale=0.5]{img/567Tree.eps}
...
\begin{figure}[H]
	...
	%\includegraphics[scale = 0.5]{img/ProgEnvMem.eps}
